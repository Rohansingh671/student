                        ...
                        <form action="php/addfees.php" method="POST">
                            ...
                            if ($mysqli) {
                                if (isset($_GET['id']) && !empty($_GET['id'])) {
                                    $stmt = $mysqli->prepare("SELECT `fnameOfStudent`, `lnameOfStudent`, `admissionNumber`, `rollNumber`, `class`, `section`,`admissionDate`, `rollNumber`, `feesGroup` FROM `addstudent` WHERE ID = ?;");
                                    ...
                                    <div class="row row-cols-xxl-5 row-cols-md-6">
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="studentID" value="<?php echo $_GET['id'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="admissionNumber" value="<?php echo htmlspecialchars($row['admissionNumber']); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Roll Number</label>
                                                <input type="text" class="form-control" name="rollNumber" value="<?php echo htmlspecialchars($row['rollNumber']); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Courses</label>
                                                <input type="text" class="form-control" name="class" value="<?php echo htmlspecialchars($row['class']); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="courseFee" value="Rs <?php echo $totalFees ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="totalPaid" value="Rs <?php echo $totalPaid ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
