            ...
            <div class="content content-two">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    <div class="my-auto mb-2">
                        <h3 class="mb-1">Edit Fees Group</h3>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="fees-group.php">Fees Group</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Edit Fees Group</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <form action="php/updateFeesGroup.php?id=<?php echo $ID; ?>" method="POST">
                            <div class="card">
                                <div class="card-header bg-light">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h4 class="text-dark">Fees-group Information</h4>
                                    </div>
                                </div>
                                <div class="card-body pb-1">
                                    <div class="row row-cols-xxl-5 row-cols-md-6">
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Fees Group ID</label>
                                                <input type="text" class="form-control" value="<?php echo $feesGroupID; ?>" name="feesGroupID" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Fees Group Name</label>
                                                <input type="text" class="form-control" value="<?php echo  $feesGroup; ?>" name="feesGroup">
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Fees Amount</label>
                                                <input type="text" class="form-control" name="feesGroupAmount" value="<?php echo  $feesGroupAmount; ?>">
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="select" name="feesGroupStatus">
                                                    ...
                                                    <option value="Active" <?php echo ($feesGroupStatus == 'Active') ? 'selected' : ''; ?>>Active</option>
                                                    <option value="Inactive" <?php echo ($feesGroupStatus == 'Inactive') ? 'selected' : ''; ?>>Inactive</option>
                                                </select>
                            ...
                            <div class="text-end">
                                ...
                                <button type="submit" class="btn btn-primary">Edit feesGroup</button>
                            </div>
                        </form>
                    </div>
                </div>
