                        ...
                        <div class="custom-datatable-filter table-responsive">
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    if ($mysqli) {
                                        $stmt = $mysqli->prepare("SELECT feescollection.ID, addstudent.ID, addstudent.fnameOfStudent, addstudent.lnameOfStudent, addstudent.class, addstudent.rollNumber, addstudent.feesGroup, feescollection.AmountPaid FROM `feescollection` INNER JOIN addstudent ON addstudent.ID = feescollection.StudentID ORDER BY feescollection.ID DESC;");
                                        $stmt->execute();
                                        $stmt->store_result();
                                        $stmt->bind_result($ID, $studentID, $fnameOfStudent, $lnameOfStudent, $class, $rollNumber, $feesGroup, $AmountPaid);
                                        $sn = 1;
                                        while ($stmt->fetch()) {
                                            echo "<tr>";
                                            echo "<td>";
