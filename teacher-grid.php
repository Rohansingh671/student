...
<body>
                        ...
                        <div class="col-xxl-3 col-xl-4 col-md-6 d-flex">
                            <div class="card flex-fill">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="teacher-details.php?id=<?php echo $teacher['id']; ?>" class="btn btn-light btn-sm">View Details</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
    ...
    <script src="js/jquery-3.7.1.min.js" type="48e4db01089c2adcf048d809-text/javascript"></script>
