...
<body>
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li hidden><a href="teacher-details.php" class="active">Teacher Details</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                            ...
                            <div class="d-flex my-xl-auto right-content align-items-center  flex-wrap">
                                ...
                                <a href="edit-teacher.php?id=<?php echo $id; ?>" class="btn btn-primary d-flex align-items-center mb-2"><i class="ti ti-edit-circle me-2"></i>Edit Teacher</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center flex-wrap row-gap-3">
                                    <div class="d-flex align-items-center justify-content-center avatar avatar-xxl border border-dashed me-2 flex-shrink-0 text-dark frames">
                                        <img src="./php/uploads/teacher_images/<?php echo $teacher_image; ?>" class="img-fluid" alt="img">
                                    </div>
                                    <div>
                                        <h5 class="mb-1 mb-1 text-truncate"><?php echo $first_name; ?></h5>
                                        <p class="text-primary mb-1"><?php echo $teacher_id; ?></p>
                                        <p>Joined : <?php echo $date_of_joining; ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <dl class="row mb-0">
                                    <dt class="col-6 fw-medium text-dark mb-3">Courses</dt>
                                    <dd class="col-6  mb-3"><?php echo $class; ?></dd>
                                    <dt class="col-6 fw-medium text-dark mb-3">Sub-courses</dt>
                                    <dd class="col-6  mb-3"><?php echo $subject_name; ?></dd>
                                    ...
                                    <dd class="col-6  mb-3"><?php echo $language_known; ?></dd>
                                </dl>
                            </div>
                        </div>
                        <div class="card border-white">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <p><?php echo $primary_contact_number; ?></p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__"><?php echo $email_address; ?></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body pb-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            <p class="text-dark"><?php echo $pan_number; ?></p>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="hostel">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="mb-1"><?php echo $hostel; ?>, Floor</h6>
                                                <p class="text-primary">Room No : <?php echo $room_number; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="transport">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-dark"><?php echo $route; ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <p class="text-dark"><?php echo $vehicle_number; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    <span class="fs-12 mb-1">Pickup Point</span>
                                                    <p class="text-dark"><?php echo $pickup_point; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="bg-light-300 border rounded d-flex align-items-center justify-content-between mb-3 p-2">
                                            <div class="d-flex align-items-center overflow-hidden">
                                                ...
                                                <div class="ms-2">
                                                    <p class="text-truncate fw-medium text-dark"><?php echo $resume; ?></p>
                                                </div>
                                            </div>
                                            <a href="./php/uploads/documents/<?php echo $resume; ?>" class="btn btn-dark btn-icon btn-sm"><i class="ti ti-download"></i></a>
                                        </div>
                                        <div class="bg-light-300 border rounded d-flex align-items-center justify-content-between p-2">
                                            <div class="d-flex align-items-center overflow-hidden">
                                                <span class="avatar avatar-md bg-white rounded flex-shrink-0 text-default"><i class="ti ti-pdf fs-15"></i></span>
                                                <div class="ms-2">
                                                    <p class="text-truncate fw-medium text-dark"><?php echo $joining_letter; ?></p>
                                                </div>
                                            </div>
                                            <a href="./php/uploads/documents/<?php echo $joining_letter; ?>" class="btn btn-dark btn-icon btn-sm"><i class="ti ti-download"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <p><?php echo $previous_school_name; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <p class="mb-1 text-dark fw-medium">School Address</p>
                                                    <p><?php echo $previous_school_address; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <p class="mb-1 text-dark fw-medium">Phone Number</p>
                                                    <p><?php echo $previous_school_contact_number; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="js/jquery-3.7.1.min.js" type="782ca94e19d1e86cda3738a1-text/javascript"></script>
