    ...
    <div class="main-wrapper">
                        ...
                        <div class="dropdown ms-1">
                            ...
                            <div class="dropdown-menu">
                                <div class="d-block">
                                    ...
                                    <hr class="m-0">
                                    <a class="dropdown-item d-inline-flex align-items-center p-2" href="php/logout_sms.php"><i class="ti ti-login me-2"></i>Logout</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="page-wrapper">
            <div class="content">
                    ...
                    <div class="col-md-12">
                        <div class="alert-message">
                            <div class="alert alert-success rounded-pill d-flex align-items-center justify-content-between border-success mb-4" role="alert">
                                <div class="d-flex align-items-center">
                                    <span class="me-1 avatar avatar-sm flex-shrink-0"><img src="./images/haitomns.jpg" alt="Img" class="img-fluid rounded-circle"></span>
                                    <p>Visit our site through,<strong class="mx-1">www.haitomns.com</strong> Contact us at,<strong class="mx-1">+977 9801126858 &nbsp; +977 9812265365</strong></p>
                                </div>
                                ...
                                <div class="d-flex align-items-xl-center justify-content-xl-between flex-xl-row flex-column">
                                    <div class="mb-3 mb-xl-0">
                                        <div class="d-flex align-items-center flex-wrap mb-2">
                                            <h1 class="text-white me-2">Haitomns Groups welcomes you!!</h1>
                                        </div>
                ...
                if ($mysqli) {
                    $stmt = $mysqli->prepare("SELECT COUNT(ID) FROM `addstudent`;");
                    $stmt->execute();
                    $stmt->bind_result($totalStudents);
                    $stmt->fetch();
                    $stmt->close();

                    $stmt = $mysqli->prepare("SELECT COUNT(ID) FROM `addteacher`;");
                    $stmt->execute();
                    $stmt->bind_result($totalTeachers);
                    $stmt->fetch();
                    $stmt->close();

                    $stmt = $mysqli->prepare("SELECT COUNT(ID) FROM `classdata`;");
                    $stmt->execute();
                    $stmt->bind_result($totalClasses);
                    $stmt->fetch();
                    $stmt->close();

                    $stmt = $mysqli->prepare("SELECT COUNT(ID) FROM `addsubject`;");
                    $stmt->execute();
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="overflow-hidden flex-fill">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h2 class="counter"><?php echo $totalStudents ?></h2>
                                        </div>
                                        <p>Total Students</p>
                                    </div>
                                </div>
                        ...
                        <div class="card flex-fill animate-card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="overflow-hidden flex-fill">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h2 class="counter"><?php echo $totalTeachers ?></h2>
                                        </div>
                                        <p>Total Teachers</p>
                                    </div>
                                </div>
                        ...
                        <div class="card flex-fill animate-card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="overflow-hidden flex-fill">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h2 class="counter"><?php echo $totalClasses ?></h2>
                                        </div>
                                        <p>Total Courses</p>
                                    </div>
                                </div>
                        ...
                        <div class="card flex-fill animate-card border-0">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="overflow-hidden flex-fill">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h2 class="counter"><?php echo $totalSubjects ?></h2>
                                        </div>
                                        <p>Total Sub-courses</p>
                                    </div>
                                </div>
                            </div>
                        </div>
