            ...
            <div class="content content-two">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <form action="php/updateStudent.php?id=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select class="select" name="class">
                                                    ...
                                                    foreach ($classes as $class1) {
                                                        ...
                                                        if ($class1['className'] === $class) { // Check if this class is the current class
                                                            echo " selected";
                                                        }
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <select class="select" name="transportationRoute">
                                                    <option>Select Transportation Route</option>
                                                    <option value="NewYork" <?php if ($transportationRoute == 'NewYork') echo 'selected'; ?>>NewYork</option>
                                                    <option value="Denver" <?php if ($transportationRoute == 'Denver') echo 'selected'; ?>>Denver</option>
                                                    <option value="Chicago" <?php if ($transportationRoute == 'Chicago') echo 'selected'; ?>>Chicago</option>
                                                </select>
