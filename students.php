                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="add-fees-master.php?id=<?php echo $student['id'] ?>" class="btn btn-light fs-12 fw-semibold me-3">Collect Fees</a>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right p-3">
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="student-details.php?id=<?php echo $student['id']; ?>"><i class="ti ti-menu me-2"></i>View Student</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="edit-student.php?id=<?php echo $student['id']; ?>"><i class="ti ti-edit-circle me-2"></i>Edit</a>
                                                            </li>
                                                            <li hidden>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="php/deleteStudentList.php?id=<?php echo $student['id']; ?>"><i class="ti ti-trash-x me-2"></i>Delete</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                    ...
                    <form>
                        <div class="modal-body text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                foreach ($students as $student) {
                                ?>
                                    <a href="php/deleteStudent.php?id=<?php echo $student['id'];
                                                                    } ?>" <button type="submit" class="btn btn-danger">Yes, Delete</button></a>
                            </div>
                        </div>
                    </form>
                </div>
