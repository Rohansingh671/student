...
<body>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right p-3">
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="teacher-details.php?id=<?php echo $teacher['id']; ?>"><i class="ti ti-menu me-2"></i>View Teacher</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="edit-teacher.php?id=<?php echo $teacher['id']; ?>"><i class="ti ti-edit-circle me-2"></i>Edit</a>
                                                            </li>
                                                            <li hidden>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="php/deleteTeacherList.php?id=<?php echo $teacher['id']; ?>"><i class="ti ti-trash-x me-2"></i>Delete</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
    ...
    <script src="js/jquery-3.7.1.min.js" type="dde9696b66c133de05567290-text/javascript"></script>
