            ...
            <div class="content content-two">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    <div class="my-auto mb-2">
                        <h3 class="mb-1">Edit Sub-course</h3>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="students.php">Sub-courses</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <form action="php/updateSubject.php?id=<?php echo $ID; ?>" method="POST">
                            ...
                            <div class="card">
                                <div class="card-header bg-light">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h4 class="text-dark">Sub-course Information</h4>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cols-xxl-5 row-cols-md-6">
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name" value="<?php echo htmlspecialchars($subject_id); ?>" name="subject_id" required readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Name</label>
                                                <input type="text" class="form-control" placeholder="Enter Name" value="<?php echo htmlspecialchars($name); ?>" name="name" required>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                            ...
                            <div class="text-end">
                                ...
                                <button type="submit" class="btn btn-primary">Edit Sub-course</button>
                            </div>
                        </form>
                    </div>
                </div>
