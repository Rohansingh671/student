...
<body>
                            ...
                            <div class="my-auto mb-2">
                                ...
                                <nav>
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Fees Details</li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <div class="col-xxl-9 col-xl-8">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bottom mb-4" hidden>
                                    <li>
    ...
    <script src="js/jquery-3.7.1.min.js" type="f86350ca7d3162ae69f3f9c8-text/javascript"></script>
