                    ...
                    <ul>
                        <li>
                            <a href="javascript:void(0);"
                                ...
                                <img src="./images/arialogo.jpg" class="avatar avatar-md img-fluid rounded"
                                    alt="Profile">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pb-1">
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                                                ...
                                                <div class="profile-upload">
                                                    ...
                                                    <p class="fs-12">Upload image size 4MB, Format JPG, PNG, SVG (mandatory)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row row-cols-xxl-5 row-cols-md-6">
                                        ...
                                        $result = $mysqli->query("SELECT admissionNumber FROM addstudent ORDER BY ID DESC LIMIT 1");
                                        $row = $result->fetch_row();

                                        if ($row == null) {
                                            $student_id = 1;
                                            $total_student_id = $student_id; // Initialize $total_student_id for this condition
                                        } else {
                                            $student_id = substr($row[0], 3);
                                            $total_student_id = $student_id + 1;
                                        }
                                        ?>

                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Admission Number &nbsp; <i class="fa-sharp fa-solid fa-star"></i></label>
                                                <input type="text" class="form-control" name="admission_number" value="AD00<?php echo $total_student_id ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Admission Date &nbsp; <i class="fa-sharp fa-solid fa-star"></i></label>
                                        ...
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Status &nbsp; <i class="fa-sharp fa-solid fa-star"></i></label>
                                                <select class="select" name="status">
                                                    <option value="">Select</option> <!-- Empty value for validation -->
                                        ...
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">First Name &nbsp; <i class="fa-sharp fa-solid fa-star"></i></label>
                                                <input type="text" class="form-control" name="first_name">
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Last Name &nbsp; <i class="fa-sharp fa-solid fa-star"></i></label>
                                                <input type="text" class="form-control" name="last_name">
                                            </div>
                                        </div>
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <?php
                                            // Ensure the classes array is loaded
                                            require_once 'php/classDataFromDatabase.php';
                                            ?>
                                            <div class="mb-3">
                                                <label class="form-label">Courses &nbsp; <i class="fa-sharp fa-solid fa-star"></i></label>
                                                <select class="select" name="class">
                                                    <option value="">Select</option>
                                                    <?php
                                                    foreach ($classes as $class) {
                                                        echo "<option value='" . htmlspecialchars($class['className']) . "'>" . htmlspecialchars($class['className']) . "</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <div class="mb-3">
                                                    ...
                                                    <p>Upload image size of 4MB, Accepted Format jpeg/png</p>
                                                </div>
                                                <div class="d-flex align-items-center flex-wrap">
