            ...
            <div class="content content-two">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <form action="php/updateClass.php?id=<?php echo $ID; ?>" method="POST">
                            <div class="card">
                                        ...
                                        <div class="col-xxl col-xl-3 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="select" name="classStatus">
                                                    ...
                                                    <option value="Active" <?php echo ($classStatus == 'Active') ? 'selected' : ''; ?>>Active</option>
                                                    <option value="Inactive" <?php echo ($classStatus == 'Inactive') ? 'selected' : ''; ?>>Inactive</option>
                                                </select>
