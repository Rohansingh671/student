                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="#" class="link-primary"><?php echo $subject['subject_id']; ?></a></td>
                                            <td><?php echo $subject['name']; ?></td>
                                            <td><?php echo $subject['code']; ?></td>
                                            <td><?php echo $subject['type']; ?></td>
                                            <td>
                                                <span class="badge badge-soft-success d-inline-flex align-items-center"><i class="ti ti-circle-filled fs-5 me-1"></i><?php echo $subject['status']; ?></span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right p-3">
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="edit-subject.php?id=<?php echo $subject['ID']; ?>"><i class="ti ti-edit-circle me-2"></i>Edit</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item rounded-1" href="php/deleteSubject.php?id=<?php echo $subject['ID']; ?>"><i class="ti ti-trash-x me-2"></i>Delete</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
