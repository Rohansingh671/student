                                ...
                                <div class="row row-cols-xxl-5 row-cols-md-6">
                                    <div class="col-xxl col-xl-3 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            $result = $mysqli->query("SELECT teacher_id FROM addteacher ORDER BY ID DESC LIMIT 1");
                                            $row = $result->fetch_row();

                                            if ($row == null) {
                                                $teacher_id = 1;
                                                $total_teacher_id = $teacher_id; // Ensure $total_teacher_id is initialized
                                            } else {
                                                $teacher_id = substr($row[0], 3);
                                                $total_teacher_id = $teacher_id + 1; // Correctly compute $total_teacher_id
                                            }
                                            ?>
                                    ...
                                    <div class="col-xxl col-xl-3 col-md-6">
                                        ...
                                        ?>
                                        <div class="mb-3">
                                            <label class="form-label">Leading Course</label>
